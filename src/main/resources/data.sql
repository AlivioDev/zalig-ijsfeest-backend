...
#
# insert into users (username, email, first_name, last_name, password, phone_number, role) VALUES ('user', 'user@test.nl', 'user', 'testklant', '1234', '0123456789', 'USER');
# insert into admins (admin_name, email, password, role) VALUES ('admin', 'admin@test.nl', '1234', 'ADMIN');

# insert into authorities (username, authority) VALUES ('user', 'USER');
# insert into authorities (adminName, authority) VALUES ('admin', 'ADMIN');
